...
save_plot(p, "UMAP-vis-sampleID.png", width = 8, height = 6)
...
for (cl in clusters) {
  ...
  save_plot(
    p1,
    paste0("heatmap_cluster_", cl, ".png"),
    width = 14,
    height = 6
  )
}
...
## Assign colors
Finally, we assign colors to all celltypes and metaclusters. The color vectors below are kept from the neuroblastoma reference analysis as a template — adapt the celltype/metacluster names and colors to match the celltypes obtained from the AD annotation above.
