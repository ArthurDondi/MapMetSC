...
# Supplementary_Tables can live inside the cohort dir or beside it (Zenodo bundle).
...
file_path <- file.path(suppl_dir, "20260526_Suppl_Table3_AD.xlsx")
if (!file.exists(file_path))
  stop("AD cluster annotation not found: ", file_path, "\n",
       "The AD phenotyping needs a table (sheet 'Sheet1', columns `cluster`, `celltype`, ",
       "`metacluster`) mapping THIS run's AD clusters to cell types. Create it from this ",
       "step's cluster heatmaps, or point `file_path` at your annotation file.")
