...
```{r read-data}
spe <- readRDS(file.path(params$output,"spe_QC_2_AD.rds"))
...
col_celltype <- c(
  ...
  "CHGA- CD15+ chromaffin progenitors"           = rgb(0,   145, 150, maxColorValue = 255),  # teal / blue-green
...
saveRDS(spe, file.path(params$output, "spe_phenotyping_AD.rds"))
