...
spe <- spe[, spe$timepoint == "DE" | spe$control == "yes"]
...
p1 <- dittoRidgePlot(spe[,spe$tissue%in%tissue], var = 'DNA1_Ir191_mean', group.by = "tissue", assay = "counts") +
    ggtitle(paste(marker,  "- per tissue"))
p2 <- dittoRidgePlot(spe[,spe$tissue%in%tissue], var = 'DNA2_Ir193_mean', group.by = "tissue", assay = "counts") +
    ggtitle(paste(marker,  "- per tissue"))
p <- (p1 | p2)
