...
# Plot only the Lee-predicted TME celltypes: drop the PT/BM "tumor"/"other"
# background cells so the UMAP shows (and the legend lists) just the Lee
# reference celltypes.
protein_lee <- protein[, !protein$celltype_predicted %in% c("tumor", "other")]

p1 <- dittoDimPlot(protein_lee, var = "celltype_predicted",
