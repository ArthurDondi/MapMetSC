...
```{r fig3a-combined, fig.width=14, fig.height=18}
...
p_age_m <- ggplot(meta_df, aes(x = sample_id, y = 1, fill = age_diag)) +
  ...
  scale_fill_gradientn(
    colors = attr(col_age_diag, "colors"),
    values = scales::rescale(attr(col_age_diag, "breaks")),
    na.value = "white", name = "Age", guide = "none"
  ) +
  labs(y = "Age")
...
p_tumhet_m <- ggplot(meta_df, aes(x = sample_id, y = 1, fill = TUM_het)) +
  meta_layers +
  scale_fill_gradientn(
    colors = attr(col_tumor_het, "colors"),
    values = scales::rescale(attr(col_tumor_het, "breaks")),
    na.value = "white", name = "TUM_het", guide = "none"
  ) +
  labs(y = "TUM_het")
...
p_mehet_m <- ggplot(meta_df, aes(x = sample_id, y = 1, fill = ME_het)) +
  meta_layers +
  scale_fill_gradientn(
    colors = attr(col_me_het, "colors"),
    values = scales::rescale(attr(col_me_het, "breaks")),
    na.value = "white", name = "ME_het", guide = "none"
  ) +
  labs(y = "ME_het")
...
p_fig3a <- (p_dendro /
  ...
  p_meta_c /
  p_immune_c) +
  plot_layout(ncol = 1, heights = c(2, 4, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 3, 3))

p_fig3a

save_plot(p_fig3a, "Fig3a_combined_stacked.png", width = 14, height = 18)
```
