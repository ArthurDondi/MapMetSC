...
save_plot(p_ME, "Fig3a3_PT_abundance_patients_clustered_immune.png", width = 8, height = 6)
```
...
save_plot(p_all, "Fig3a3_PT_abundance_patients_clustered_metacluster.png", width = 8, height = 6)
```
