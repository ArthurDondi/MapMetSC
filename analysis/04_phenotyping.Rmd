...
spe$pg_clusters <- spe$pg_clusters_k45
```
...
col_celltype <- c(
  ...
  "GD2- Tu"      = rgb(40,  150,130, maxColorValue = 255),
  ...
  "CD8+ S100B+ T cells"      = rgb(199,  21, 133, maxColorValue = 255),
  "CD8+ GZMB+ T cells"       = rgb(220,  90,  40, maxColorValue = 255),
  ...
  "myeloid"     = rgb(64, 180, 170, maxColorValue = 255),
