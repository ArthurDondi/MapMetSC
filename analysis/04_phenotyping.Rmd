...
col_celltype <- c(
  ...
  ## ---- Tumor ----
  "CXCR4+ Tu"     = rgb(107, 142,  35, maxColorValue = 255),   # olive drab
  "CD44+ Tu"      = rgb(50,  205,  50, maxColorValue = 255),   # bright lime green
  "GD2neg Tu"      = rgb(189, 183, 107, maxColorValue = 255),  # khaki
  "Ki67+ Tu"      = rgb(173, 255,  47, maxColorValue = 255),   # chartreuse
  "early neuroblast-like Tu"   = rgb(152, 251, 152, maxColorValue = 255),  # pale green
  "marker-low Tu"  = rgb(34,  100,  60, maxColorValue = 255),   # dark green
  "neuroblast-like Tu" = rgb(0, 160, 110, maxColorValue = 255),    # teal green
  ...
  "CD8+ S100B+ T cells"      = rgb(255,  20, 147, maxColorValue = 255),  # deep pink
  "CD8+ GZMB+ T cells"       = rgb(255, 140,   0, maxColorValue = 255),  # dark orange
