...
missing_objects <- required_objects[!vapply(required_objects, function(x) exists(x, inherits = TRUE), logical(1))]
if (length(missing_objects) > 0) {
  stop(sprintf("Missing required objects for Fig4d combined plot: %s. Please run the preceding chunks `cohort-overview`, `dendrogram`, and `plot-metadata` first.", paste(missing_objects, collapse = ", ")))
}
...
# Tuned to keep dendrogram readable, prioritize abundance panel, and keep metadata compact.
