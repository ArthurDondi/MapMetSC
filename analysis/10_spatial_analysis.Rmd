...
if (length(missing_objects) > 0) {
  stop(sprintf("Missing required objects for Fig4d combined plot: %s. Please run the preceding chunks `cohort-overview`, `dendogram`, and `plot-metadata` first.", paste(missing_objects, collapse = ", ")))
}
