...
for (compare in comparisons_list) {
  ...
  df_list <- df_list[match(as.character(experiment_info$sample_id), names(df_list))]
...
for (cells in cells_list) {
  ...
  # p_adj comes directly from the paired diffcyt model (FDR-adjusted within each comparison run)
