...
We will now repeat the same workflow for PT samples.
...
# morph feature matrix for the remaining cells
...
# Map each mask file to its SPE sample_id (adjust for your object)
mask_to_spe_ids <- c(
  "20220517_20220309_20-154_BM_003",
  "20220926_20220809_16-005_TU_001"
)

names(masks) <- mask_to_spe_ids
mcols(masks)$sample_id <- mask_to_spe_ids

# One plot per morphological feature x mask, saved individually
