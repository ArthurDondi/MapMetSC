...
In the images above, we can see that segmentation artifacts occur, where no clear cell borders can be identified. For BM, we determined an upper threshold of **15,600** and for PT a lower threshold of **250**. To examine nuclei with an area below the lower threshold, it is better to visualize images in napari and use the label and zoom function.
